...
(0, _alpinejsDefault.default).data("reportPage", ()=>({
        id: getQueryParam("id") || crypto.randomUUID()?.substring(0, 6) || "unknown",
...
},{"alpinejs":"69hXP","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"69hXP":[function(require,module,exports,__globalThis) {
