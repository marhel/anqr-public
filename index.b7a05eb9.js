...
var _reportPage = require("./reportPage");
var _reportPageDefault = parcelHelpers.interopDefault(_reportPage);
// suggested in the Alpine docs:
// make Alpine on window available for better DX
window.Alpine = (0, _alpinejsDefault.default);
(0, _alpinejsDefault.default).data("reportPage", (0, _reportPageDefault.default));
(0, _alpinejsDefault.default).start();

},{"alpinejs":"69hXP","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./reportPage":"dngMJ"}],"69hXP":[function(require,module,exports,__globalThis) {
...
exports.default = ()=>({
        ...
        report () {
            ...
            fetch("https://7qqeuzwht3w44weoj7tmw73fyq0xndgj.lambda-url.eu-north-1.on.aws/", {
                ...
                this.score += this.position == "1st" ? 10 : 5;
                localStorage.setItem("score", this.score.toString());
                this.ducks += 1;
                localStorage.setItem("ducks", this.ducks.toString());
            }).catch((error)=>alert("Error sending report." + error));
        }
    });

},{"./utils":"dsXzW","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","anqr-js":"kfYgd","ordinal":"erA5W"}],"dsXzW":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kfYgd":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
// Reduce-like function that processes sightings as they arrive
parcelHelpers.export(exports, "processSightings", ()=>processSightings);
var _utils = require("./utils");
async function fetchSightings(options) {
    return fetch(options.lambda, {
        method: "POST",
        headers: {
            "Content-Type": "application/json"
        },
...
async function* getAllSightings(options) {
    // Initial "next" param is empty
    const opts = {
        ...options
    };
    while(true){
        const data = await fetchSightings(opts);
        if ("message" in data) {
            console.error(data.message);
            return;
        }
        const { next: newNext, sightings } = data;
        for (const sighting of sightings){
            sighting.timestamp = (0, _utils.epochToDate)(sighting.timestamp);
            yield sighting; // Yield each item one by one
        }
        if (!newNext) break; // Stop when "next" is empty
        opts.params.next = newNext;
    }
}
async function processSightings(reducer, initialValue, options) {
    let accumulator = initialValue;
    for await (const sighting of getAllSightings(options))accumulator = reducer(accumulator, sighting);
    return accumulator;
}

},{"./utils":"lwM0k","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lwM0k":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getQueryParam", ()=>getQueryParam);
parcelHelpers.export(exports, "epochToDate", ()=>epochToDate);
function getQueryParam(name) {
    const urlParams = new URLSearchParams(window.location.search);
    return urlParams.get(name);
}
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"erA5W":[function(require,module,exports,__globalThis) {
var indicator = require("a3fda61ce52b6f55");
function ordinal(i) {
...
},{"a3fda61ce52b6f55":"bowOC"}],"bowOC":[function(require,module,exports,__globalThis) {
